...
class Cluster_definition_widget(QDialog):
    def __init__(self, df,mongo_client,EP_DB_NAME,CLUTSER_COL_NAME,parent=None):
        ...
        self.cluster_tbl_view = Sort_and_filter_tbl_view(parent=self)
        self.cluster_tbl_view.set_df(df)
