...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.start_date_time_edit, 0, 6, 1, 1)

        self.query_push_btn = QPushButton(self.centralwidget)
        self.query_push_btn.setObjectName(u"query_push_btn")

        self.gridLayout.addWidget(self.query_push_btn, 0, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.site_line_edit, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.cluster_line_edit, 0, 3, 1, 1)
        ...
        self.tabwidget_level1.setCurrentIndex(6)
