...
if __name__ == '__main__':
    ...
    now = time.time()
    timestamps = numpy.linspace(now - 3600, now, 10)


    # w.plot(x=timestamps, y=numpy.random.rand(100), symbol='o')
    bg1 = pg.BarGraphItem(x=timestamps, height=numpy.random.rand(10),  brush='r')
    bg2 = pg.BarGraphItem(x=timestamps, height=numpy.random.rand(10),  brush='b')
